...
# To run tests python -m unittest scripts.yolo.non_maximal_suppression_test
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_remove_overlapping_predictions(self):
        ...
        filtered_predictions = non_maximal_suppression(predictions, intersection_over_union)
