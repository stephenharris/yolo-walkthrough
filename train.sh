...
nohup /home/ubuntu/darknet/darknet detector train ${DATA_CFG} ${MODEL_CFG} ${PRETRAINED_WEIGHTS} -dont_show -mjpeg_port 8090 -map > /home/ubuntu/${PWD}/${S3_BUCKET_NAME}/yolo.log &
